    ...
    public partial class criarbanco : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReceitaIngresiente", x => new { x.ReceitaId, x.IngredienteId });
                    table.ForeignKey(
                        name: "FK_ReceitaIngresiente_Ingrediente_IngredienteId",
                        column: x => x.IngredienteId,
                        principalTable: "Ingrediente",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ReceitaIngresiente_Receita_ReceitaId",
                        column: x => x.ReceitaId,
                        principalTable: "Receita",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "ddf093a6-6cb5-4ff7-9a64-83da34aee005", 0, "5d475db9-aec1-4468-9a25-0e03d07246fa", "admin@damelascook.com", true, false, null, "ADMIN@DAMELASCOOK.COM", "ADMIN", "AQAAAAIAAYagAAAAEMrkFokxuPg7e3xFqEOKDwkMdcjVviwuPdapDTeqxvyyRBHx2sNJ1qcMsKEuGSlOcw==", null, false, "f5ed03fc-59f9-4056-b8e8-41dadd5cf3de", false, "Admin" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "ddf093a6-6cb5-4ff7-9a64-83da34aee005", new DateTime(2008, 3, 31, 0, 0, 0, 0, DateTimeKind.Unspecified), "/img/usuarios/avatar.png", "Laura Bressanin Ortigosa" });

            migrationBuilder.InsertData(
                table: "ReceitaIngresiente",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReceitaIngresiente_IngredienteId",
                table: "ReceitaIngresiente",
